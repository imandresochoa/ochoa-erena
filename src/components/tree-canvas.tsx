...
import { contextById, selImage } from "@/domain/sel";
import {
  collapsePath,
  expandPinId,
  firstPathPoint,
            ...
            return (
              ...
              >
                <Image
                  ...
                  sizes={`${selImage.width}px`}
                  className="sel-image pointer-events-none absolute left-1/2 bottom-full -translate-x-1/2"
                  priority
                />
                <button
                  type="button"
